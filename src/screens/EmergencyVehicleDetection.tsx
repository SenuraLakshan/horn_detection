...
const EmergencyVehicleDetection = () => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={styles.header}>
                <Text style={styles.headerText}>🚨 Emergency Vehicle Detection</Text>
            </View>
            {/* 🔵 Radar Effect */}
            <View style={styles.radarSection}>
                ...
                <Text style={styles.radarLabel}>🔍 Scanning for Emergency Vehicles...</Text>
            </View>
            {/* App Title */}
            <Text style={styles.title}>Emergency Vehicle Detection</Text>
            {/* Status Card */}
            {!showAlertScreen && (
            ...
            <View style={styles.alertBox}>
                ...
                <Text style={styles.alertMessage}>
                    {alertMessage ? alertMessage : 'No emergency vehicle detected yet.'}
                </Text>
            </View>
            {/* Alert Overlay */}
            {showAlertScreen && (
...
export default EmergencyVehicleDetection;